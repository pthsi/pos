...
-- Dumping data for table pos.ospos_inventory: ~229 rows (approximately)
...
INSERT INTO `ospos_sales_suspended` (`sale_time`, `customer_id`, `employee_id`, `comment`, `invoice_number`, `sale_id`) VALUES
...
-- Dumping data for table pos.ospos_sales_suspended_items: ~1 rows (approximately)
...
-- Dumping data for table pos.ospos_sales_suspended_payments: ~1 rows (approximately)
